...
import { ContactFlexContainer, ContactForm, ContactFormFields, ContactFormGroup, ContactPageContainer, ContactsTextContainer } from '@/styles/contact-page.styles';
      ...
      <ContactPageContainer>
         <ContactsTextContainer>
            ...
            <ContactFlexContainer hasMoreGap>
               ...
               >
                  ...
                  <ContactCardText>
                     <Link href='mailto:isaacphiri315@gmail.com'>isaacphiri315@gmail.com</Link>
                  </ContactCardText>
               </ContactCard>
               <ContactCard
                  icon='calling'
         ...
         <ContactForm className={montserrat.className}>
            ...
            <ContactFormFields>
               ...
               <textarea name="first-name" placeholder='Enter your message' rows={6} />
            </ContactFormFields>
